	...
	<div class="header">
		...
		<div class="wrapper">
			...
			<ul class="nav">
                ...
                <li class="suggest<?php if ($section == "suggest") { echo " on"; } ?>"><a href="catalog.php">Suggest</a></li>
				<li class="suggest<?php if ($section == "suggest") { echo " on"; } ?>"><a href="suggest.php">Feedback</a></li>
            </ul>
